...
fun DashboardScreen(navController: NavController) {
    ...
    Scaffold(
        bottomBar = {
            BottomNavigationBar(selectedItem.value) { selected ->
        ...
        LazyRow {
            items(5) {
                Box(
                    ...
                    Text("Category ${it + 1}", fontSize = 14.sp, color = Color.White)
                }
            }
        }
...
fun OrdersScreen() {
    Box(
        ...
        Text("Orders Screen", fontSize = 20.sp, fontWeight = FontWeight.Medium)
    }
}
...
fun InventoryScreen() {
    Box(
        ...
        Text("Inventory Screen", fontSize = 20.sp, fontWeight = FontWeight.Medium)
    }
}

@Composable
fun BottomNavigationBar(selectedItem: String, onItemSelected: (String) -> Unit) {
    val items = listOf("home", "orders", "inventory")
    val labels = listOf("Home", "orders", "inventory")
    val icons = listOf(Icons.Filled.Home, Icons.Filled.List, Icons.Filled.Face)

    NavigationBar(containerColor = newgrey4) {
